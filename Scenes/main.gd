...
var bossesSpawned = 0
var bossesKilled = 0
var shouldSpawnBosses:bool = (Singleton.level % 2 == 0)
...
func _ready() -> void:
	...
	GlobalSignals.bossKilled.connect(_on_boss_death)
...
func _on_mob_timer_timeout() -> void:
	...
	# Set the mob's position to a random location.
		...
		add_child(e)
	if shouldSpawnBosses and bossesSpawned < bossesToSpawn and bossesKilled == bossesSpawned:
		bossesSpawned += 1
...
func _on_end_timer_timeout() -> void:
	if !isWinner:
		...
		GlobalSignals.emit_signal("nextScene")
